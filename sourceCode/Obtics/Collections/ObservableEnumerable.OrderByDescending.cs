...
namespace Obtics.Collections
{
    public static partial class ObservableEnumerable
    {
        ...
        public static IObservableOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
        { return OrderByDescending(source, keySelector, Comparer<TKey>.Default); }

        /// <summary>
        /// Sorts the elements of a sequence in descending order according to a key using a given <see cref="IComparer{TKey}"/>.
        /// </summary>
        /// <typeparam name="TSource">Type of the elements of the sequence.</typeparam>
        /// <typeparam name="TKey">Type of the key as returned by <paramref name="keySelector"/>.</typeparam>
        /// <param name="source">The sequence of values to sort.</param>
        ...
        public static IObservableOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer)
        { return OrderBy(source, keySelector, comparer.Inverted()); }
        ...
        /// <returns>An <see cref="IObservableOrderedEnumerable{TSource}"/>, whose elements are sorted to a key, or null when either <paramref name="source"/> or <paramref name="keySelector"/> is null.</returns>
        public static IObservableOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, IValueProvider<TKey>> keySelector)
        { return OrderByDescending(source, keySelector, Comparer<TKey>.Default); }

        /// <summary>
        /// Sorts the elements of a sequence in descending order according to a key dynamicaly using a given <see cref="IComparer{TKey}"/>.
        /// </summary>
        /// <typeparam name="TSource">Type of the elements of the sequence.</typeparam>
        /// <typeparam name="TKey">Type of the key as returned by <paramref name="keySelector"/>.</typeparam>
        /// <param name="source">The sequence of values to sort.</param>
        ...
        /// <param name="comparer">An <see cref="IComparer{TKey}"/> to comparer key values.</param>
        /// <returns>An <see cref="IObservableOrderedEnumerable{TSource}"/>, whose elements are sorted to a key, or null when either <paramref name="source"/>, <paramref name="keySelector"/> or <paramref name="comparer"/> is null.</returns>
        public static IObservableOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, IValueProvider<TKey>> keySelector, IComparer<TKey> comparer)
        { return OrderBy(source, keySelector, comparer.Inverted()); }
    }
}
