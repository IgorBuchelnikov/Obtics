...
namespace Obtics.Collections
{
    public static partial class ObservableEnumerable
    {
        ...
        public static IValueProvider<TSource> LastOrDefault<TSource>(this IEnumerable<TSource> source)
        { return _LastOrDefault(source).Concrete(); }

        internal static IInternalValueProvider<TSource> _LastOrDefault<TSource>(this IEnumerable<TSource> source)
        { return LastOrDefaultAggregate<TSource>.Create(source); }
        ...
        public static IValueProvider<TSource> LastOrDefault<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate)
        { return _LastOrDefault(source, predicate).Concrete(); }

        internal static IInternalValueProvider<TSource> _LastOrDefault<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate)
        { return FindLastOrDefaultAggregate<TSource>.Create(source, predicate); }
        ...
        /// <returns>An <see cref="IValueProvider{TSource}"/>, whose Value property will give the last element that satisfies the condition in the source sequence or default(<typeparamref name="TSource"/>) if such an element can not be found, or null when <paramref name="source"/> is null.</returns>
        public static IValueProvider<TSource> LastOrDefault<TSource>(this IEnumerable<TSource> source, Func<TSource, IValueProvider<bool>> predicate)
        { return _LastOrDefault(source, predicate).Concrete(); }

        internal static IInternalValueProvider<TSource> _LastOrDefault<TSource>(this IEnumerable<TSource> source, Func<TSource, IValueProvider<bool>> predicate)
        {
            return
                FindLastOrDefaultAggregate<Tuple<TSource, bool>>.Create(
