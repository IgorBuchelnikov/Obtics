...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class SumAggregateSingleTest
    {
        public SumAggregateSingleTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                55f,
                frame => SumAggregateSingle.Create(frame),
                "SumAggregateSingle.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<float, float>
        {
            ...
            {
                return SumAggregateSingle.Create(frame);
            }

            public override string Prefix
            {
                get { return "SumAggregateSingle.Create(frame)"; }
            }
        }
        ...
        {
                var r = SumAggregateSingle.Create(null);
