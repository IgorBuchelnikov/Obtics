...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class SumAggregateNullableDecimalTest
    {
        public SumAggregateNullableDecimalTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                45m,
                frame => SumAggregateNullableDecimal.Create(frame),
                "SumAggregateNullableDecimal.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<decimal?, decimal?>
        {
            ...
            {
                return SumAggregateNullableDecimal.Create(frame);
            }

            public override string Prefix
            {
                get { return "SumAggregateNullableDecimal.Create(frame)"; }
            }
        }
        ...
        class CorrectnessRunner2 : CollectionTestSequenceRunnerForAggregate<decimal?, decimal?>
        {
            ...
            static List<decimal?> filler = new List<decimal?>(
                new decimal?[] { -4.332m, 5m, -3m, -78.45m, 14m, 12.223m }
            );
        ...
        {
                var r = SumAggregateNullableDecimal.Create(null);
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                s => SumAggregateNullableDecimal.Create(s),
                "SumAggregateNullableDecimal"
            );
        }
    }
}
