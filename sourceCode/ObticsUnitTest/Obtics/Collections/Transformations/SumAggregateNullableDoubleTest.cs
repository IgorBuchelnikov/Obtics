...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class SumAggregateNullableDoubleTest
    {
        public SumAggregateNullableDoubleTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                45d,
                frame => SumAggregateNullableDouble.Create(frame),
                "SumAggregateNullableDouble.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<double?, double?>
        {
            ...
            {
                return SumAggregateNullableDouble.Create(frame);
            }

            public override string Prefix
            {
                get { return "SumAggregateNullableDouble.Create(frame)"; }
            }
        }
        ...
        {
                var r = SumAggregateNullableDouble.Create(null);
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                s => SumAggregateNullableDouble.Create(s),
                "SumAggregateNullableDouble"
            );
        }
    }
}
