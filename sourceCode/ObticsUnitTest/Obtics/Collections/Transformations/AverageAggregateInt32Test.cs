...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class AverageAggregateInt32Test
    {
        public AverageAggregateInt32Test()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                5.5d,
                frame => AverageAggregateInt32.Create(frame).OnException((InvalidOperationException ex) => 222),
                "AverageAggregateInt32.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<int, double>
        {
            ...
            {
                return AverageAggregateInt32.Create(frame).OnException( (InvalidOperationException ex) => 222.0 );
            }

            public override string Prefix
            {
                get { return "AverageAggregateInt32.Create(frame)"; }
            }
        }
        ...
        class DeterministicEventRegistrationRunner : CollectionDeterministicEventRegistrationRunnerForAggregate<int, double>
        {
            ...
            {
                return AverageAggregateInt32.Create(frame).OnException((InvalidOperationException ex) => 222d);
            }
        ...
        {
            Assert.IsNull(AverageAggregateInt32.Create(null), "Should return null when source is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                s => AverageAggregateInt32.Create(s),
                "AverageAggregateInt32"
            );
        }
    }
}
