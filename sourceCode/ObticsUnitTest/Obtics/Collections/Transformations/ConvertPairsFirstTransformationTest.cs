...
{
    /// <summary>
    /// Summary description for ConvertPairsFirstTransformationTest
    /// </summary>
    [TestClass]
    public class ConvertPairsFirstTransformationTest
    {
        public ConvertPairsFirstTransformationTest()
        {
            //
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForTransformation<Pair<string, string>, string>
        {
            ...
            {
                return new ConvertPairsFirstTransformation<string, string>( frame );
            }

            public override string Prefix
            {
                get { return "new ConvertPairsFirstTransformation<string, string>( frame )"; }
            }
        }
        ...
        public void ArgumentsCheck_source()
        {
            try
            {
                var r = new ConvertPairsFirstTransformation<string, string>(null);
            }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                s => new ConvertPairsFirstTransformation<string, string>(s),
                "ConvertPairsFirstTransformation<string, string>"
            );
        }
    }
}
