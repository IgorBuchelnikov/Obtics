...
{
    /// <summary>
    /// Summary description for AnyAggregateTest
    /// </summary>
    [TestClass]
    public class AnyAggregateTest
    {
        public AnyAggregateTest()
        {
            //
        ...
        public void ConcurrencyTest1()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                true,
                frame => AnyAggregate.Create(frame),
                "AnyAggregate.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<bool, bool>
        {
            ...
            {
                return AnyAggregate.Create(frame);
            }

            public override string Prefix
            {
                get { return "new AnyAggregate(frame)"; }
            }
        }
        ...
        {
            List<bool> source = new List<bool>(
                new bool[] { false, false, false, false, false, false, false, false, false, false, true, true, false }
            );
        ...
        {
            Assert.IsNull(AnyAggregate.Create(null), "Should return null when source is null.");
        }
