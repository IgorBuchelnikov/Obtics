...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class ExtremityAggregateSpecificTest_Inverted
    {
        public ExtremityAggregateSpecificTest_Inverted()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                8,
                frame => ExtremityAggregate<int>.Create(frame, Comparer<int>.Default).OnException((InvalidOperationException ex) => 222),
        ...
        {
            var r = ExtremityAggregate<int>.Create(null, new ReversedComparer());
