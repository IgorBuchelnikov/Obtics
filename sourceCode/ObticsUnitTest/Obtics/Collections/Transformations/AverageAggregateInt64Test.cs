...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class AverageAggregateInt64Test
    {
        public AverageAggregateInt64Test()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                5.5d,
                frame => AverageAggregateInt64.Create(frame).OnException((InvalidOperationException ex) => 222L),
                "AverageAggregateInt64.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<long, double>
        {
            ...
            {
                return AverageAggregateInt64.Create(frame).OnException( (InvalidOperationException ex) => 222.0 );
            }

            public override string Prefix
            {
                get { return "AverageAggregateInt64.Create(frame)"; }
            }
        }
        ...
        class DeterministicEventRegistrationRunner : CollectionDeterministicEventRegistrationRunnerForAggregate<long, double>
        {
            ...
            {
                return AverageAggregateInt64.Create(frame).OnException((InvalidOperationException ex) => 222d);
            }
        ...
        {
            Assert.IsNull(AverageAggregateInt64.Create(null), "Should return null when source is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                s => AverageAggregateInt64.Create(s),
                "AverageAggregateInt64"
            );
        }
    }
}
