...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class ExtremityAggregateNullableValueTest
    {
        public ExtremityAggregateNullableValueTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                8,
                frame => ExtremityAggregateNullableValue<int>.Create(frame),
                "ExtremityAggregateNullableValue<int>.Create(frame, false)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<int?, int?>
        {
            ...
            {
                return ExtremityAggregateNullableValue<int>.Create(frame);
            }
        ...
        {
            Assert.IsNull(ExtremityAggregateNullableValue<int>.Create(null), "Should return null when source is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                new int?[0], new int?[] { 1 },
                s => ExtremityAggregateNullableValue<int>.Create(s),
                "ExtremityAggregateNullableValue<int>"
            );
        }
