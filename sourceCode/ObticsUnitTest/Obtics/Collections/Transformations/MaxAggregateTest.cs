...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class ExtremityAggregateTest
    {
        public ExtremityAggregateTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                8,
                frame => ExtremityAggregateValue<int>.Create(frame).OnException((InvalidOperationException ex) => 222),
                "ExtremityAggregate<int>.Create(frame, false)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<int, int>
        {
            ...
            {
                return ExtremityAggregateValue<int>.Create(frame).OnException((InvalidOperationException ex) => 222);
            }
        ...
        {
            Assert.IsNull(ExtremityAggregateValue<int>.Create(null), "Should return null when source is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                new int[0], new int[] { 1 },
                s => ExtremityAggregateValue<int>.Create(s),
