...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class SumAggregateDoubleTest
    {
        public SumAggregateDoubleTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                55d,
                frame => SumAggregateDouble.Create(frame),
                "SumAggregateDouble.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<double, double>
        {
            ...
            {
                return SumAggregateDouble.Create(frame);
            }

            public override string Prefix
            {
                get { return "SumAggregateDouble.Create(frame)"; }
            }
        }
        ...
        {
                var r = SumAggregateDouble.Create(null);
