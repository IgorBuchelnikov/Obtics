...
{
    /// <summary>
    /// Summary description for UnorderedLookupTransformationTest
    /// </summary>
    [TestClass]
    public class UnorderedLookupTransformationTest
    {
        public UnorderedLookupTransformationTest()
        {
            //
        ...
        static GroupFilterConverterTransformation<TOut, TKey> udtSource<TOut, TKey>(IEnumerable<Tuple<TOut, TKey>> source, IEqualityComparer<TKey> comparer)
        {
            return
                (GroupFilterConverterTransformation<TOut, TKey>)
                    GroupFilterConverterTransformation<TOut, TKey>.Create(source, comparer).UnorderedForm;
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForTransformation<Tuple<string, string>, IGrouping<string, string>>
        {
            ...
            public override bool VerifyResult(object tail, string description, int count)
            {
                ...
                bool res = 
                    grps.Select(grp => grp.Key).SequenceEqual(new string[] { "A", "B", "C", "E", "F" })
                    && Enumerable.SequenceEqual(grps[0], new string[] { "AB", "AD", "AC", "AB" })
                    && Enumerable.SequenceEqual(grps[2], new string[] { "CD" })
                    && Enumerable.SequenceEqual(grps[3], new string[] { "EF", "EA", "EA" })
                    && Enumerable.SequenceEqual(grps[1], new string[] { "BE" })
            ...
            {
                return SortTransformation<IGrouping<string, string>,string>.Create( UnorderedLookupTransformation<string, string>.Create(udtSource(frame, ObticsEqualityComparer<string>.Default)), g => g.Key, Comparer<string>.Default);
            }

            public override string Prefix
            {
                get { return "SortTransformation<IGrouping<string, string>,string>.Create( UnorderedLookupTransformation<string, string>.Create(udtSource(frame, ObticsEqualityComparer<string>.Default)), g => g.Key, Comparer<string>.Default)"; }
            }
        }
        ...
        class DeterministicEventRegistrationRunner : CollectionDeterministicEventRegistrationRunnerForTransformation<Tuple<string, string>, IGrouping<string, string>>
        {
            ...
            {
                return UnorderedLookupTransformation<string, string>.Create( udtSource( frame, ObticsEqualityComparer<string>.Default ));
            }

            public override string Prefix
            {
                get { return "new UnorderedLookupTransformation<string, string>(frame, EqualityComparer<string>.Default)"; }
            }
        }
        ...
        {
            Assert.IsNull(UnorderedLookupTransformation<string, string>.Create(null), "Should return null when source is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                (s, c) => UnorderedLookupTransformation<string, string>.Create( udtSource(s, c) ),
                "UnorderedLookupTransformation<string, string>"
            );
        }
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionTransformation.Run(
                ...
                frame => 
                    SortTransformation<IGrouping<string, string>,string>.Create( 
                        UnorderedLookupTransformation<string, string>.Create( 
                            udtSource( frame, ObticsEqualityComparer<string>.Default)
                        ), 
                        g => g.Key, 
                        Comparer<string>.Default
                    ),
                "SortTransformation<IGrouping<string, string>,string>.Create( UnorderedLookupTransformation<string, string>.Create( udtSource( frame, ObticsEqualityComparer<string>.Default)), g => g.Key, Comparer<string>.Default)"
            );
        }
    }
}
