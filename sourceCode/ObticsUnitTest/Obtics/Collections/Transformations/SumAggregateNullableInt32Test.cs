...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class SumAggregateNullableInt32Test
    {
        public SumAggregateNullableInt32Test()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                45,
                frame => SumAggregateNullableInt32.Create(frame),
                "SumAggregateNullableInt32.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<int?, int?>
        {
            ...
            {
                return SumAggregateNullableInt32.Create(frame).OnException((OverflowException ex) => (int?)222);
            }

            public override string Prefix
            {
                get { return "SumAggregateNullableInt32.Create(frame)"; }
            }
        }
        ...
        class CorrectnessRunner3 : CollectionTestSequenceRunnerForAggregate<int?, int?>
        {
            ...
            public override IValueProvider<int?> CreatePipeline(FrameIEnumerable<int?> frame)
            {
                return SumAggregateNullableInt32.Create(frame).OnException((OverflowException ex) => (int?)333);
            }
        ...
        class DeterministicEventRegistrationRunner : CollectionDeterministicEventRegistrationRunnerForAggregate<int?, int?>
        {
            ...
            {
                return SumAggregateNullableInt32.Create(frame);
            }
        ...
        {
                var r = SumAggregateNullableInt32.Create(null);
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                s => SumAggregateNullableInt32.Create(s),
                "SumAggregateNullableInt32"
            );
        }
