...
{
    /// <summary>
    /// Summary description for ExtremityAggregateSpecificTest
    /// </summary>
    [TestClass]
    public class ExtremityAggregateSpecificTest
    {
        public ExtremityAggregateSpecificTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                ...
                "ExtremityAggregate<int>.Create(frame, new ReversedComparer(), false)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<int, int>
        {
            ...
            {
                return ExtremityAggregate<int>.Create(frame, new ReversedComparer()).OnException((InvalidOperationException ex) => 222) ;
            }

            public override string Prefix
            {
                get { return "ExtremityAggregateSpecific<int>.Create(frame, new ReversedComparer() )"; }
            }
        }
        ...
        {
            Assert.IsNull(ExtremityAggregate<int>.Create(null, Comparer<int>.Default), "Should return null when source is null.");
        }

        [TestMethod]
        public void ArgumentsCheck_comparer()
        {
            Assert.IsNull(ExtremityAggregate<int>.Create((new int[0]), null), "Should return null when comparer is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                "ExtremityAggregateSpecific<int>"
            );
        }
    }
}
