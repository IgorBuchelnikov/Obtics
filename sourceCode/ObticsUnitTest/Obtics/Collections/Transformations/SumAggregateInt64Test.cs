...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class SumAggregateInt64Test
    {
        public SumAggregateInt64Test()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                55L,
                frame => SumAggregateInt64.Create(frame),
                "SumAggregateInt64.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<long, long>
        {
            ...
            {
                return SumAggregateInt64.Create(frame).OnException((OverflowException ex) => 222L);
            }

            public override string Prefix
            {
                get { return "SumAggregateInt64.Create(frame)"; }
            }
        }
        ...
        class DeterministicEventRegistrationRunner : CollectionDeterministicEventRegistrationRunnerForAggregate<long, long>
        {
            ...
            {
                return SumAggregateInt64.Create(frame);
            }
        ...
        {
                var r = SumAggregateInt64.Create(null);
