...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class AsyncTransformationTest
    {
        public AsyncTransformationTest()
        {
            //
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForTransformation<string, string>, IWorkQueue
        {
            ...
            {
                return AsyncTransformation<string>.Create(frame,this);
            }
            ...
            {
                get { return "new BufferTransformation<string>(frame,this)"; }
            }
        ...
        {
            Assert.IsNull(AsyncTransformation<string>.Create(null,new DeterministicEventRegistrationRunner()), "Should return null when source is null.");
        }

        [TestMethod]
        public void ArgumentsCheck_workQueue()
        {
            Assert.IsNull(AsyncTransformation<string>.Create(StaticEnumerable<string>.Create(new string[0]), null), "Should return null when workQueue is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                (s, wk) => AsyncTransformation<string>.Create(s, wk),
                "BufferTransformation<string>"
            );
        }
        ...
        public void ConcurrencyTest()
        {
            AsyncTestRunnerForCollectionTransformation.Run(
                ...
                s => AsyncTransformation<int>.Create(s, new MTWorkQueue()),
