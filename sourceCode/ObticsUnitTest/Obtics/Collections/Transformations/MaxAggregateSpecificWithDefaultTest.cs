...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class ExtremityAggregateSpecificWithDefaultTest
    {
        public ExtremityAggregateSpecificWithDefaultTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                ...
                "ExtremityAggregate<int>.Create(frame, new ReversedComparer(), 1024, false)"
            );
        }
        ...
        public void ConcurrencyTest2()
        {
            ...
            var stub = new int[] { 100 };

            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                1,
                frame => ExtremityAggregate<int>.Create( global::Obtics.Collections.ObservableEnumerable.Concat(frame, stub), new ReversedComparer()),
                "ExtremityAggregate<int>.Create(frame, new ReversedComparer(), 1024, false)"
            );
        }
