...
namespace ObticsUnitTest.Obtics.Collections.Transformations
{
    ...
    /// </summary>
    [TestClass]
    public class AverageAggregateNullableSingleTest
    {
        public AverageAggregateNullableSingleTest()
        {
            //
        ...
        public void ConcurrencyTest()
        {
            ...
            AsyncTestRunnerForCollectionAggregate.Run(
                source.ToArray(),
                5f,
                frame => AverageAggregateNullableSingle.Create(frame).OnException((InvalidOperationException ex) => (float?)222f),
                "AverageAggregateNullableSingle.Create(frame)"
            );
        }
        ...
        class CorrectnessRunner : CollectionTestSequenceRunnerForAggregate<float?, float?>
        {
            ...
            {
                return AverageAggregateNullableSingle.Create(frame);
            }

            public override string Prefix
            {
                get { return "AverageAggregateNullableSingle.Create(frame)"; }
            }
        }
        ...
        {
            Assert.IsNull(AverageAggregateNullableSingle.Create(null), "Should return null when source is null.");
        }
        ...
        public void EqualityTest()
        {
            EqualityRunner.Run(
                ...
                s => AverageAggregateNullableSingle.Create(s),
                "AverageAggregateNullableSingle"
            );
        }
    }
}
