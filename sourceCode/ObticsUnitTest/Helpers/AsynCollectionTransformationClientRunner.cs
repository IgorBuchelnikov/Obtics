...
{
    internal class AsynValueTransformationClientRunner<TType>
    {
        ValueProviderClient<TType>[] _Clients;
        IValueProvider<TType> _Source;
        bool _Running;
        bool _Stop;

        public AsynValueTransformationClientRunner(ValueProviderClient<TType>[] clients, IValueProvider<TType> source)
        {
            if (clients == null)
